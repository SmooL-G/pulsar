#!/usr/bin/env python3
"""Deploy pinned messages feature."""
...
WEB_FILES = [
    ...
    'apps/web/src/components/chat/PinnedMessageBanner.tsx',
    'apps/web/src/components/chat/MessageBubble.tsx',
    'apps/web/src/components/chat/MessageList.tsx',
    'apps/web/src/components/layout/ChatArea.tsx',
    'apps/web/src/i18n/en.ts', 'apps/web/src/i18n/ru.ts',
    'apps/web/src/i18n/de.ts', 'apps/web/src/i18n/es.ts',
    'apps/web/src/i18n/fr.ts', 'apps/web/src/i18n/ja.ts',
    'apps/web/src/i18n/ko.ts', 'apps/web/src/i18n/pt.ts',
    'apps/web/src/i18n/tr.ts', 'apps/web/src/i18n/uk.ts',
