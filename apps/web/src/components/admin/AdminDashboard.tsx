...
import { Users, MessageCircle, UserPlus, Wifi, MessagesSquare, UsersRound, Server, Banknote, Gift, Trophy, Zap } from 'lucide-react';
...
export function AdminDashboard() {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Lottery + Activity toggles (admin/super_admin) */}
      <LotteryToggle />
      <ActivityToggle />
